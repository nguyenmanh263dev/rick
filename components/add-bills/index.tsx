...
import CreateCategoryModal from 'app/profile/container/category/components/CreateCategoryModal';
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => (
          <Bill
            ...
            autoSetDate={date => {
              const updatedData = listData.map((item, idx) =>
                idx < index ? item : { ...item, date }
              );
              setListData(updatedData);
            }}
            onDelete={() => {
